...
// sticky navigation intersection Obsetver API
...
const loading = function (enteries, observer) {
  const [entery] = enteries
  console.log(entery)
...
// // message.textContent = 'we use cookies for improved functionality and anal';
...
//   alert('onmoyseenter: great you are reading the heading')
// }
